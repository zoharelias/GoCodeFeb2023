...
function sortUpOrDown(upOrDown,firstNum,secondNum,thirdNum,forthNum,fifthNum){
    const arrayToReturn = [];
...
console.log(sortUpOrDown('up',2,1,77,5,6));
console.log(sortUpOrDown('down',2,1,77,5,6));
console.log(sortUpOrDown('xx',2,1,77,5,6));
